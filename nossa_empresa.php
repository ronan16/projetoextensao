<?php
	...
	if(isset($_SESSION['dataCurso']) ){
		...
		header('location:./controllers/controllerIndex.php?acao=nossa_empresa');
		exit;
	}
?>
            ...
            <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel" >
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <h1 style="text-align: center;">JÚNIOR CONSULTORIA</h1>
                        <p style="text-align: justify; margin:25px;">Empresas Júnior, são denominadas as empresas compostas por universitários, que unem conhecimentos técnicos atualizados de várias áreas.</p>
                        <p style="text-align: justify; margin:25px;">A Univale Júnior Consultoria, Empresa Júnior dos cursos de Administração, Ciências Contábeis e Análise e Desenvolvimento de Sistemas, oferece assistência a pequenos empreendedores e empresários na gestão de negócios.</p>
                        <p style="text-align: justify; margin:25px;">Tem como objetivo auxiliar pequenos empreendedores e empresários que tiverem questões relacionadas a seus negócios. Ajudando com dificuldades como crescimento abaixo do desejável ou falta do retorno financeiro, problema financeiro no fluxo de caixa, questões sobre o melhoramento do atendimento aos clientes, marketing e questões relacionadas a área de software e informatização.</p>
                        <p style="text-align: justify; margin:25px;">Os membros que participam da Univale Júnior Consultoria são acadêmicos que buscam colocar em prática o conhecimento adquirido em sala de aula. Contando com a orientação de professores da Univale.</p>
